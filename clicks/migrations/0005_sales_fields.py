...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Visitor.offer_2_revenue'
        db.add_column('clicks_visitor', 'offer_2_revenue', self.gf('django.db.models.fields.FloatField')(default=0, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Visitor.offer_2_revenue'
        db.delete_column('clicks_visitor', 'offer_2_revenue')
    ...
    models = {
        ...
        'clicks.visitor': {
            ...
            'date_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 2, 14, 12, 2, 51, 882565)'}),
