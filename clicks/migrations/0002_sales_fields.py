...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Visitor.offer_1_exit_sale'
        db.add_column('clicks_visitor', 'offer_1_exit_sale', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Visitor.offer_1_exit_sale'
        db.delete_column('clicks_visitor', 'offer_1_exit_sale')
    ...
    models = {
        ...
        'clicks.visitor': {
            ...
            'date_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 2, 14, 12, 2, 15, 598275)'}),
